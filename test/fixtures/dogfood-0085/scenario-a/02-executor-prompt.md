Prompt #1 — Implement Spec Task 9001-dogfood-scenario-a

Implement exactly what docs/sdd/9001-dogfood-scenario-a/spec.md requires. Do not add, remove, or
reinterpret requirements. If the spec is unclear or contradictory,
stop and report a blocking issue instead of guessing.

Write these files in .ai-runs/tasks/9001-dogfood-scenario-a/ (the task's runtime evidence folder,
NOT the spec's own directory):
  - .ai-runs/tasks/9001-dogfood-scenario-a/03-executor-log.md
  - .ai-runs/tasks/9001-dogfood-scenario-a/07-tests.txt
  - .ai-runs/tasks/9001-dogfood-scenario-a/08-executor-summary.md

=== Spec (docs/sdd/9001-dogfood-scenario-a/spec.md) ===
# Dogfood Scenario A — straightforward accepted task

Add a file named OK.txt at the repository root containing exactly the text
"ok". This is a deliberately trivial, bounded, safe fixture spec used only to
dogfood SpecRelay's executor/reviewer lifecycle (SDD 0085 dogfood scenario A)
inside an isolated harness — it is not real product work.
